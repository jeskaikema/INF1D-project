<div class="Sidebar">      
    ...
    <div class="S-1">
        ...
        <div class="S-Item">
            ...
            <a href="orderForm.php"><h4>Bestellingen</h4></a>   
        </div>
    </div>
    ...
    <div class="S-2">
        ...
        <div class="S-Item">
            <a href="faq.php"><h4>Need help?</h4></a>
        </div>
    </div>
